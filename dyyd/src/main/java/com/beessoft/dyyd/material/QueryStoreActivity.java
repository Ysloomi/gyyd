...
public class QueryStoreActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        context =QueryStoreActivity.this;
	...
	private void visitServer() {
		String httpUrl = User.mainurl + "survey/AppSurveyShopList";
						...
						try {
							...
							if (code.equals("1")) {
								...
								for (int j = 0; j < array.length(); j++) {
									...
									map.put("belong", "归属商客:"+obj.getString("gssk"));
									map.put("num", "门牌号:"+obj.getString("mph"));
									map.put("name", "商铺名:"+obj.getString("spm"));
									datas.add(map);
								}
								simAdapter = new SimpleAdapter(
										QueryStoreActivity.this,
										datas,// 数据源
								...
								listView.setOnItemClickListener(new OnItemClickListener() {
									...
									public void onItemClick(AdapterView<?> parent, View view,
										...
										Intent intent =new Intent(QueryStoreActivity.this,StoreResearchActivity.class);
