...
public class BranchTargetActivity extends BaseActivity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_home:
			Toast.makeText(BranchTargetActivity.this, "已返回顶层目录",
