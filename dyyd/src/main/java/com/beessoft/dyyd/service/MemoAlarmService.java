package com.beessoft.dyyd.service;
...
import com.beessoft.dyyd.dailywork.MyMemoListActivity;
...
//		mNotification.setLatestEventInfo(this,getResources().getString(R.string.app_name), "有一条备忘录",
//				pendingIntent);
