...
public class VisitReachActivity extends BaseActivity {
	...
	private String  type,customerType, examineResultString, longtitude, latitude,
			addr;
//			examineUrl, ifExamine;
...
//	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.visitreach);
		...
		public void onClick(View v) {
			switch (v.getId()){
				case R.id.txt_get_customer:
					String customer = customerEdit.getText().toString();
					Intent intent = new Intent();
				...
				case R.id.txt_preserve:
					String aim = aimEdit.getText().toString();
					// 记住目的信息
				...
				case R.id.btn_submit:
					if(haveSpinner){
						String customer1 = customerEdit.getText().toString();
						String person = personEdit.getText().toString();
						String aim1 = aimEdit.getText().toString();
...
//						} else {
							if (
//									TextUtils.isEmpty(customerType.trim()) ||
									TextUtils.isEmpty(customer1.trim())
									|| TextUtils.isEmpty(person.trim())
									|| TextUtils.isEmpty(aim1.trim())
...
//							if ("0".equals(ifExamine)) {
								if ("渠道类".equals(customerType)&&Tools.isEmpty(leavetype)){
									...
									confirmInfo(customer1,person,aim1,location);
								}
//							} else {
...
//	}
	...
	public void confirmInfo(final String customer,final String person,
							final String aim, final String location) {
			...
			builder.setTitle("不再有效范围是否确认提交")
					.setPositiveButton("是", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							visitServer(customer, person, aim,location);
						}
...
//	}
	...
	private void visitServer(String customer, String person, String aim, String location) {
