...
public class MyWorkAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.mMes1 = (TextView) convertView.findViewById(R.id.message1);
		...
		if ("渠道拜访".equals(name)) {
			...
			holder.mMes1.setText(map.get("message"));
			holder.mMes.setVisibility(View.GONE);
			holder.mMes1.setVisibility(View.VISIBLE);
		}
		return convertView;
	}
